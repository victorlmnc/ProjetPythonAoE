...
class Unit:
    def __init__(self, hp, attack, armor, pierce_armor, rng, line_of_sight,
                 speed, attacks, armours, Build_time, Reload_Time, image_path, position=(0,0), team=1):
        self.hp = hp
        self.attack = attack
        self.armor = armor
...
class LongSwordsman(Infantry):
    def __init__(self, position=(0,0), team=1):
        super().__init__(
            hp=60, attack=9, armor=1, pierce_armor=1, rng=0, line_of_sight=4, speed=1.0,
            Build_time=21, Reload_Time=2,
            attacks={"Shock Infantry": 6, "Standard Buildings": 3, "Base Melee": 9,
                     "Mounted Units": 0, "Camels": 0, "All Archers": 0},
            armours={"Infantry":0, "Base Melee":1, "Base Pierce":1, "Obsolete":0},
...
class Pikeman(Infantry):
    def __init__(self, position=(0,0), team=1):
        super().__init__(
            hp=55, attack=7, armor=0, pierce_armor=0, rng=0, line_of_sight=4, speed=1.2,
            Build_time=22, Reload_Time=3,
...
class Knight(Cavalry):
    def __init__(self, position=(0,0), team=1):
        super().__init__(
            hp=100, attack=10, armor=2, pierce_armor=2, rng=0, line_of_sight=4, speed=1.35,
            Build_time=30, Reload_Time=1.8,
        ...
        self.FrameDelay = 13
        self.AttackDelay = 0.67

class Crossbowman(Archer):
    def __init__(self, position=(0,0), team=1):
        super().__init__(
            hp=35, attack=5, armor=0, pierce_armor=0, rng=5, line_of_sight=7, speed=0.96,
            Build_time=27, Reload_Time=2,
            attacks={"Spear Units":3, "Standard Buildings":0, "Base Pierce":5,
                     "High Pierce Armor Siege Units":0, "Stone Defense & Harbors":0},
            armours={"Base Melee":0, "All Archers":0, "Base Pierce":0, "Obsolete":0},
            image_path="images/crossbowman.WEBP",
            position=position,
            team=team
        )
        self.FrameDelay = 15
        self.AttackDelay = 0.35
        self.accuracy = 0.85
