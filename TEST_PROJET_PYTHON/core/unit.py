...
class Knight(Unit):
    ...
    def __init__(self, unit_id: int, army_id: int, pos: tuple[float, float]):
        super().__init__(
            ...
            hp=100, speed=2.0, attack_power=10, attack_range=1.5, cost=100
        )
...
class Pikeman(Unit):
    ...
    def __init__(self, unit_id: int, army_id: int, pos: tuple[float, float]):
        super().__init__(
            unit_id=unit_id, army_id=army_id, pos=pos,
            hp=60, speed=1.0, attack_power=5, attack_range=1.5, cost=40
        )
...
class Archer(Unit):
    ...
    def __init__(self, unit_id: int, army_id: int, pos: tuple[float, float]):
        super().__init__(
            unit_id=unit_id, army_id=army_id, pos=pos,
            hp=40, speed=1.0, attack_power=4, attack_range=7.0, cost=60
        )